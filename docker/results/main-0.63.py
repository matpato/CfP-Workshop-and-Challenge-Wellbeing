...
featureSelector =  LinearSVC(dual = False, random_state = 42, penalty = 'l1',tol = 1e-05,  intercept_scaling = 1, loss = 'squared_hinge', max_iter = 100000,
                             multi_class = 'crammer_singer',C = 0.6, class_weight = None,)
